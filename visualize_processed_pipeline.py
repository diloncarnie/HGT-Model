...
def visualize_processed_pipeline(network_file, processed_file, show_all=False, time_window=5.0):
    ...
    hover_cols = {
        ...
        "lane_index": True,
        "num_lanes": True,
        "proportionate_distance_travelled": ":.3f",
        "speed": ":.2f",
        "segment_free_flow_speed": ":.2f",
        "relative_kinematic_ratio": ":.3f",
        # Occupancy
        "relative_occupancy_proceeding": ":.2f",
        "relative_occupancy_following": ":.2f",
        "relative_occupancy_leftwards": ":.2f",
        "relative_occupancy_rightwards": ":.2f",
        # Density
        ...
        "relative_speed_leftwards": ":.2f",
        "relative_speed_rightwards": ":.2f",
        # Lat/Lon hidden
        "lat": False,
        "lon": False,
